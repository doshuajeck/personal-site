    ...
    const loadBlogPosts = async () => {
      try {
        ...
        for (const file of blogFiles) {
          try {
            const response = await fetch(`./personal-site/blog/${file}`);
            if (response.ok) {
  ...
  const portfolioItems = [
    {
      ...
      title: "Goomba",
      type: "image",
      thumbnail: `./personal-siteportfolio/goomba.jpg`,
    ...
    },
    {
      ...
      title: "Life Flask",
      type: "video",
      thumbnail: `./personal-site/portfolio/flask.jpg`,
      description: "Created with Blender"
    },
    {
      id: 3,
      title: "Mage Staff",
      type: "image",
      thumbnail: `./personal-site/portfolio/staff.jpg`,
      description: "Created with Blender"
    },
    {
      id: 4,
      title: "Neighbor",
      type: "image",
      thumbnail: `./personal-site/portfolio/neighbor.jpg`,
      description: "Created with Blender"
    }
  ];
